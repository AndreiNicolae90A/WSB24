    ...
    products.forEach(function (product) {
        ...
        <div class="card mb-30"><a class="card-img-tiles" href="#" data-abc="true">
            ...
            <div class="card-body text-center">
                <h4 class="card-title">
                    <span style="height:3px; width:3px; background-color:${product.product_colors[0]};"> span </span>
                     ${product.name} ${product.category}</h4>
                <p class="text-muted">Starting from ${product.price}</p>
                <p class="text-muted">Clients rating - ${product.rating}</p>
